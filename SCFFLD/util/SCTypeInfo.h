 ...
 */
@interface SCPropertyInfo : NSObject {
...
/** Test whether the property type is a subclass of another class. */
- (BOOL)isSubclassOf:(__unsafe_unretained Class)classObj;
/** Test whether an instance the property type conforms to the specified protocol. */
 ...
 * @return Information about the specified property, @see <SCPropertyInfo>.
