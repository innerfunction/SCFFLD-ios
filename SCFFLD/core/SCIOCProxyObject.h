 ...
 * a standard method for proxy class registration in SCContainer. Subclasses can invoke the
 * [registerConfigurationProxyClass: forClassName:] class method from their class [load] method;
 * SCContainer will then call the [registerProxyClasses] method on this class.
 ...
 */
@interface SCIOCProxyObject : NSObject <SCIOCProxy>
