 ...
 * In this case, the name part is treated as a string template (using @see <SCStringTemplate>) which is
 ...
 */
@interface SCStringSchemeHandler : NSObject <SCSchemeHandler>
