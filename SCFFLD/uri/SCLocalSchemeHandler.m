...
@implementation SCLocalResource
...
- (void)setData:(id)data {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SCNotificationLocalDataUpdate" object:_key];
}
...
@implementation SCLocalSchemeHandler
...
- (id)dereference:(SCCompoundURI *)uri parameters:(NSDictionary *)params {
    ...
    SCLocalResource *resource = [[SCLocalResource alloc] initWithData:nil uri:uri];
