...
@class SCTableViewCellFactory;

@protocol SCTableViewCellDecorator <NSObject>

- (UITableViewCell *)decorateCell:(UITableViewCell *)cell data:(id<SCConfiguration>)data factory:(SCTableViewCellFactory *)factory;

@end

/**
 * A factory class for generating table view cell instances.
 * (Note that this class is _not_ an @see <SCIOCObjectFactory> instance).
 */
@interface SCTableViewCellFactory : NSObject {
}

@property (nonatomic, strong) id<SCTableViewCellDecorator> decorator;
