...
#import "SCUIBarButtonItemProxy.h"
#import "SCActionProxy.h"

@implementation SCUIBarButtonItemProxy
...
- (void)notifyIOCObject:(id)object propertyName:(NSString *)propertyName {
    ...
    // button is tapped.
    if (_action && [object conformsToProtocol:@protocol(SCActionProxy)]) {
        id<SCActionProxy> actionProxy = (id<SCActionProxy>)object;
...
+ (void)load {
    [SCIOCProxyObject registerConfigurationProxyClass:self forClassName:@"UIBarButtonItem"];
}
