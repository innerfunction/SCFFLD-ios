 ...
 * The class implements the _SCMessageReceiver_ protocol and responds to the following message:
 ...
 */
@interface SCWebViewController : SCViewController <UIWebViewDelegate, SCMessageReceiver> {
