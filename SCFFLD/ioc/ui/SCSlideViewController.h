 ...
 *
 * The class implements the _MessageReceiver_ protocol and responds to the following messages:
 ...
 *
 * The class implements the _SCMessageRouter_ protocol and provides the following targets, which
 * messages can be addressed to:
 * - _main_: The main view area.
 * - _slide_: The slide view area.
 */
@interface SCSlideViewController : SWRevealViewController <SCMessageReceiver, SCMessageRouter> {
