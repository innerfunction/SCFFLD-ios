 ...
 * The class implements the SCMessageReceiver protocol and respond to the following messages:
 ...
 */
@interface SCNavigationViewController : UINavigationController <SCMessageReceiver> {
