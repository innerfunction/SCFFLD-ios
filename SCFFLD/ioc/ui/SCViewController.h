 ...
 * Implements the <MessageReceiver> protocol and responds to the following messages:
 ...
 * in the layout file.
 */
@interface SCViewController : UIViewController <SCIOCContainerAware, SCIOCConfigurationAware, SCMessageReceiver, SCMessageRouter, SCActionProxy, SCViewBehaviourController> {
