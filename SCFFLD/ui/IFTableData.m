...
- (void)setRowsConfiguration:(IFConfiguration *)rowsConfiguration {
    _rowsConfiguration = rowsConfiguration;
    _currentRowData = [[IFConfiguration alloc] initWithData:@{} parent:_rowsConfiguration];
    NSArray *rowsData;
...
- (void)setRowsData:(NSArray *)rowData {
    _rowsConfiguration = [IFConfiguration emptyConfiguration];
    _currentRowData = [[IFConfiguration alloc] initWithData:@{} parent:_rowsConfiguration];
