Pod::Spec.new do |s|
  ...
  #s.subspec 'noarc' do |sp|
    ...
    core.subspec 'NoArc' do |noarc|
        noarc.source_files = 'SCFFLD/core/IOS8601DateFormatter.*', 'SCFFLD/core/ZipArchive.*', 'SCFFLD/core/minizip/*';
    ...
    s.subspec 'Core' do |core|
        ...
        core.exclude_files = 'SCFFLD/core/IOS8601DateFormatter.*', 'SCFFLD/core/ZipArchive.*', 'SCFFLD/core/minizip/*';
    ...
    s.subspec 'HTTP' do |http|
        db.source_files = 'SCFFLD/http/*.{h,m}';
        db.requires_arc = true;
        db.compiler_flags = '-w';
        #db.frameworks = 'Foundation';
        db.dependency 'SCFFLD/Core';
